    ...
    <View style={authstyles.container}>
      ...
      <View style={authstyles.body}>
        <View style={{marginBottom: 10}}>
          <Text style={styles.buttonTextStyle}>Game Mode</Text>
          {/* TWO BUTTONs */}
          <View style={{flexDirection: 'row'}}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyle}>Single / Patti</Text>
            </TouchableOpacity>
            {/* Jodi Button */}
            <TouchableOpacity
              onPress={handleJoriData}
              style={{
                backgroundColor: active ? 'red' : 'rgba(255, 0, 0, 0.2)',
                marginLeft: 10,
                borderRadius: 5,
              }}>
              <Text style={styles.buttonTextStyle}>Jodi</Text>
            </TouchableOpacity>
          </View>
        </View>
