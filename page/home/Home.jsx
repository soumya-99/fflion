import { StyleSheet, Text, Image, View, FlatList, PixelRatio, TouchableOpacity } from 'react-native'
...
const Home = ({ navigation }) => {
  ...
  function getColorByLetter(letter) {
    ...
    const colors = ['#FF6633', '#FFB399', '#FF33FF', '#8062D6', '#00B3E6',
...
const styles = StyleSheet.create({
  ...
  playText: { fontWeight: 'bold', color: '#FF90BB', height: 60, textAlign: 'center', textAlignVertical: 'center', fontSize: 20 },
